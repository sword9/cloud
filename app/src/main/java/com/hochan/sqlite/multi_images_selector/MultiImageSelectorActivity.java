package com.hochan.sqlite.multi_images_selector;
...
public class MultiImageSelectorActivity extends AppCompatActivity implements MultiImageSelectorFragment.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar.setNavigationIcon(getResources().getDrawable(R.drawable.ic_backarrow));
        ...
        mMultiImageSelectorFragment = (MultiImageSelectorFragment) Fragment.instantiate(this, MultiImageSelectorFragment.class.getName(), bundle);
        getSupportFragmentManager().beginTransaction()
                .add(R.id.image_grid, mMultiImageSelectorFragment)
                .commit();

        tvCategoryText = (TextView) findViewById(R.id.category_btn);
        // 初始化，加载所有图片
        tvCategoryText.setText(R.string.folder_all);
        tvCategoryText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mMultiImageSelectorFragment.onCategoryChoose();
            }
        });
    ...
    @Override
    public void onCategoryChange(String gategory) {
        tvCategoryText.setText(gategory);
    }
}
