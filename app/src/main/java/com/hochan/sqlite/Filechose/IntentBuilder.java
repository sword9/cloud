...
public class IntentBuilder {
    ...
    public static void viewFile(final Context context, final String filePath) {
        ...
        if (!TextUtils.isEmpty(type) && !TextUtils.equals(type, "*/*")) {
            ...
            dialogBuilder.setTitle(net.micode.fileexplorer.R.string.dialog_select_type);

            CharSequence[] menuItemArray = new CharSequence[] {
                    context.getString(net.micode.fileexplorer.R.string.dialog_type_text),
                    context.getString(net.micode.fileexplorer.R.string.dialog_type_audio),
                    context.getString(net.micode.fileexplorer.R.string.dialog_type_video),
                    context.getString(net.micode.fileexplorer.R.string.dialog_type_image) };
