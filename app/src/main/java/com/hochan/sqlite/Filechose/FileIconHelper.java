...
package com.hochan.sqlite.Filechose;
...
import com.hochan.sqlite.Filechose.FileCategoryHelper.FileCategory;
import com.hochan.sqlite.Filechose.FileIconLoader.IconLoadFinishListener;
...
public class FileIconHelper implements IconLoadFinishListener {
    ...
    static {
        addItem(new String[] {
            "mp3"
        }, net.micode.fileexplorer.R.drawable.file_icon_mp3);
        addItem(new String[] {
            "wma"
        }, net.micode.fileexplorer.R.drawable.file_icon_wma);
        addItem(new String[] {
            "wav"
        }, net.micode.fileexplorer.R.drawable.file_icon_wav);
        addItem(new String[] {
            "mid"
        }, net.micode.fileexplorer.R.drawable.file_icon_mid);
        addItem(new String[] {
                "mp4", "wmv", "mpeg", "m4v", "3gp", "3gpp", "3g2", "3gpp2", "asf"
        }, net.micode.fileexplorer.R.drawable.file_icon_video);
        addItem(new String[] {
                "jpg", "jpeg", "gif", "png", "bmp", "wbmp"
        }, net.micode.fileexplorer.R.drawable.file_icon_picture);
        addItem(new String[] {
                "txt", "log", "xml", "ini", "lrc"
        }, net.micode.fileexplorer.R.drawable.file_icon_txt);
        addItem(new String[] {
                "doc", "ppt", "docx", "pptx", "xsl", "xslx",
        }, net.micode.fileexplorer.R.drawable.file_icon_office);
        addItem(new String[] {
            "pdf"
        }, net.micode.fileexplorer.R.drawable.file_icon_pdf);
        addItem(new String[] {
            "zip"
        }, net.micode.fileexplorer.R.drawable.file_icon_zip);
        addItem(new String[] {
            "mtz"
        }, net.micode.fileexplorer.R.drawable.file_icon_theme);
        addItem(new String[] {
            "rar"
        }, net.micode.fileexplorer.R.drawable.file_icon_rar);
    }
    ...
    public static int getFileIcon(String ext) {
        ...
        if (i != null) {
            ...
            return net.micode.fileexplorer.R.drawable.file_icon_default;
        }
    ...
    public void setIcon(FileInfo fileInfo, ImageView fileImage, ImageView fileImageFrame) {
        ...
        switch (fc) {
            ...
            case Video:
                ...
                if (set)
                    ...
                    fileImage.setImageResource(fc == FileCategory.Picture ? net.micode.fileexplorer.R.drawable.file_icon_picture
                            : net.micode.fileexplorer.R.drawable.file_icon_video);
        ...
        if (!set)
            fileImage.setImageResource(net.micode.fileexplorer.R.drawable.file_icon_default);
    }
