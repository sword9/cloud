...
public class FileListAdapter extends ArrayAdapter<FileInfo> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            view = mInflater.inflate(net.micode.fileexplorer.R.layout.file_browser_item, parent, false);
        }
        ...
        view.findViewById(net.micode.fileexplorer.R.id.file_checkbox_area).setOnClickListener(
